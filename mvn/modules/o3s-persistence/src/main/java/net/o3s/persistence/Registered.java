...
@NamedQueries( {
    ...
    @NamedQuery(name = "REGISTERED_FROM_LABEL", query = "SELECT r FROM Registered r WHERE r.label.value LIKE :VALUE AND r.event.id = :EVENTID"),
    @NamedQuery(name = "REGISTERED_FROM_LABELNUMBER", query = "SELECT r FROM Registered r WHERE r.label.number = :VALUE AND r.event.id = :EVENTID"),
    @NamedQuery(name = "REGISTERED_FROM_RFID", query = "SELECT r FROM Registered r WHERE r.label.rfid LIKE :RFID AND r.event.id = :EVENTID"),
